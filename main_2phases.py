...
if babbling:
	...
	MuJoCo_model_name = "single_leg_ws_onair.xml"
	babbling_signal_duration_in_seconds=2*60 # babbling duration
	...
	[babbling_kinematics_p1, real_attempt_sensorreads_p1, babbling_activations_p1] = run_activations_ws_ol_fcn(MuJoCo_model_name, est_activations, timestep=0.01, Mj_render=False) # this should be ol
	...
	## running the babbling data through the plant
	est_activations = babbling_signals
	[babbling_kinematics_p2, real_attempt_sensorreads_p2, babbling_activations_p2] = run_activations_ws_ol_fcn(MuJoCo_model_name, est_activations, timestep=0.01, Mj_render=False) # this should be ol
	...
	Inverse_ANN_model = inverse_mapping_ws_fcn(babbling_kinematics, real_attempt_sensorreads, babbling_activations, log_address="./log/save/{}/".format(experiment_ID), early_stopping=False)
...
[returned_kinematics, real_attempt_sensorreads, returned_est_activations ] = run_activations_ws_cl_fcn(MuJoCo_model_name, Inverse_ANN_model, attempt_kinematics, timestep=0.01, Mj_render=True) # this should be cl
